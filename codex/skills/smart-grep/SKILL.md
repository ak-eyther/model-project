---
name: smart-grep-extended
description: Expanded smart-grep playbook for token-efficient rg --json searches with examples and budgeting.
metadata:
  short-description: Smart Grep Extended
---
