...
description: Software architecture guidance for designing scalable systems. Covers architecture patterns, tech stack decisions, system design trade-offs, and integration patterns.
---

Note: Current UI is {{FRONTEND_URL}} (production) and {{STAGING_UI_URL}} (staging). Fill in via `codex/PROJECT_CONTEXT.md`.
...
| Database | {{DATABASE_STACK}} | {{DATABASE_NOTES}} |
| Memory | {{MEMORY_STACK}} | {{MEMORY_NOTES}} |
| LLM | {{LLM_STACK}} | {{LLM_NOTES}} |
| Deploy | {{DEPLOYMENT_STACK}} | {{DEPLOYMENT_NOTES}} |
